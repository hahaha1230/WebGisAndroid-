...
import com.example.hahaha.overlay.PoiOverlay;

import java.util.ArrayList;
import java.util.List;

public class PoiKrywordSearchActivity extends AppCompatActivity  implements AMap.OnMarkerClickListener ,
        AMap.InfoWindowAdapter,TextWatcher,PoiSearch.OnPoiSearchListener,View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_poi_kryword_search);
        init();
    }
    ...
    public void onPoiSearched(PoiResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(this,"1出错误"+rCode,Toast.LENGTH_SHORT).show();
        }
    ...
    public void onGetInputtips(List<Tip> tipList, int rCode) {
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
            ...
            Toast.makeText(this,"2出错误："+rCode,Toast.LENGTH_SHORT).show();
        }

...
public class WeatherSearchActivity extends AppCompatActivity  implements WeatherSearch.OnWeatherSearchListener{
    ...
    public void onWeatherLiveSearched(LocalWeatherLiveResult weatherLiveResult, int rCode) {
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            if (weatherLiveResult != null && weatherLiveResult.getLiveResult() != null) {
                ...
                Toast.makeText(WeatherSearchActivity.this,"没有结果",Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(WeatherSearchActivity.this,"错误，错误信息为:"+rCode,
    ...
    public void onWeatherForecastSearched(LocalWeatherForecastResult weatherForecastResult, int rCode) {
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(WeatherSearchActivity.this,"错误信息为："+rCode,Toast.LENGTH_SHORT).show();
        }
    }

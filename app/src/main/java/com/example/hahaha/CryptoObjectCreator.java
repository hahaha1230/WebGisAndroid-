...
public class CryptoObjectCreator {
            ...
            public void run() {
                try {
                    if (mCryptoObject != null) {
                        ...
                        // of the fingerprint.
                        if (!initCipher()) {
                            Log.d("hhh","Failed to init Cipher.");
                        }
                    }
                } catch (Exception e) {
                   Log.d("hhh"," Failed to init Cipher, e:" + Log.getStackTraceString(e));
                }
    ...
    private void createKey() {
        ...
        try {
            ...
            Log.d("hhh"," Failed to createKey, e:" + Log.getStackTraceString(e));
    ...
    private boolean initCipher() {
        try {
            ...
            Log.d("hhh"," Failed to initCipher, e:" + Log.getStackTraceString(e));
            return false;

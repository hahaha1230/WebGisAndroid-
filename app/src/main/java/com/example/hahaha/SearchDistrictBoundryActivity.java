...
import com.example.hahaha.util.ThreadUtil;

public class SearchDistrictBoundryActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_district_boundry);
    ...
    public void onDistrictSearched(DistrictResult districtResult) {
        ...
        if(districtResult.getAMapException() != null && districtResult.getAMapException().getErrorCode() == AMapException.CODE_AMAP_SUCCESS) {
            ...
            if(districtResult.getAMapException() != null) {
                Toast.makeText(SearchDistrictBoundryActivity.this,"错误信息"+districtResult.
                        getAMapException().getErrorCode(),Toast.LENGTH_SHORT).show();
